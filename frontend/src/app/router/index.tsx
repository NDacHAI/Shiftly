        ...
        <Routes>
            ...
            <Route
                ...
                element={
                    ...
                    >
                        <Layout
                            activeNavKey="nav.leaveRequests"
                            titleKey="routes.leaveRequests"
                            user={user}
                            onLogout={onLogout}
                        >
                            <LeaveRequestsPage userRole={user.role} />
                        </Layout>
                    </PermissionRoute>
                }
            />
            ...
            <Route
                ...
                element={
                    ...
                    >
                        <Layout
                            activeNavKey="nav.payrollPeriods"
                            titleKey="routes.payrollPeriods"
                            user={user}
                            onLogout={onLogout}
                        >
                            <PayrollPeriodsPage canManage={user.role === roles.admin} />
                        </Layout>
                    </PermissionRoute>
                }
            />
            <Route
                path={routes.payrollAdjustments}
                element={
                    <PermissionRoute
                        allowedRoles={[roles.admin, roles.manager]}
                        userRole={user.role}
                    >
                        <Layout
                            activeNavKey="nav.payrollAdjustments"
                            titleKey="routes.payrollAdjustments"
                            user={user}
                            onLogout={onLogout}
                        >
